...
<div class="content">
	...
	<form class="register-form" action="RegisterControl" method="post">
		<h3>Sign Up</h3>
		<p>
		...
		<div class="form-group">
			...
			<div class="input-icon">
				...
				<input class="form-control placeholder-no-fix" type="text" placeholder="Last and First name" name="fullname"/>
			</div>
		</div>
		<div class="form-group">
			<!--ie8, ie9 does not support html5 placeholder, so we just show field title for that-->
		...
		<div class="form-group">
			...
			<div class="input-icon">
				...
				<input class="form-control placeholder-no-fix" type="text" placeholder="Phone Number" name="num_tel"/>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="input-icon">
				<i class="fa fa-font"></i>
				<input class="form-control placeholder-no-fix" type="text" placeholder="Role:Expert/Candidate/Owner" name="role"/>
			</div>
		</div>
		<div class="form-group">
			<label class="control-label visible-ie8 visible-ie9">Categorie</label>
			<div class="input-icon">
				<i class="fa fa-font"></i>
				<input class="form-control placeholder-no-fix" type="text" placeholder="Category for the expert empty for others(optionnal)" name="categorie"/>
			</div>
		</div>
		<div class="form-group">
